...
packages/shared test:    Start at  23:24:38
packages/shared test:    Duration  251ms (transform 106ms, setup 0ms, collect 189ms, tests 22ms, environment 1ms, prepare 370ms)
...
packages/resource test:  ✓ src/daily-time-range.test.ts (17 tests) 13ms
...
packages/scheduling test:  ✓ src/booking.test.ts (22 tests) 14ms
...
packages/crm test:    Start at  23:24:39
packages/crm test:    Duration  922ms (transform 100ms, setup 0ms, collect 199ms, tests 12ms, environment 0ms, prepare 518ms)
packages/catalog test:  Test Files  2 passed (2)
packages/catalog test:       Tests  19 passed (19)
packages/catalog test:    Start at  23:24:39
packages/catalog test:    Duration  936ms (transform 121ms, setup 0ms, collect 237ms, tests 6ms, environment 0ms, prepare 452ms)
...
packages/scheduling test:    Start at  23:24:39
packages/scheduling test:    Duration  1.02s (transform 240ms, setup 0ms, collect 646ms, tests 30ms, environment 1ms, prepare 1.13s)
packages/resource test:  Test Files  4 passed (4)
packages/resource test:       Tests  57 passed (57)
packages/resource test:    Start at  23:24:39
packages/resource test:    Duration  1.03s (transform 163ms, setup 0ms, collect 609ms, tests 26ms, environment 1ms, prepare 901ms)
...
apps/web test:       Tests  11 passed (11)
apps/web test:    Start at  23:24:40
apps/web test:    Duration  379ms (transform 51ms, setup 0ms, collect 73ms, tests 4ms, environment 0ms, prepare 53ms)
apps/web test: Done
packages/db test:  ✓ src/drizzle-customer-repository.test.ts (7 tests) 2470ms
packages/db test:    ✓ DrizzleCustomerRepository > save した Customer を findById で全フィールド一致で取得できる 525ms
...
packages/db test:    ✓ DrizzleCustomerRepository > 同一 id で再 save すると既存データが更新される（upsert） 332ms
packages/db test:    ✓ DrizzleCustomerRepository > 行 → Customer の再構成が集約不変条件を満たす > phone のみの Customer を save → findById で再構成すると ContactInfo が不変条件を満たす 314ms
packages/db test:    ✓ DrizzleCustomerRepository > 行 → Customer の再構成が集約不変条件を満たす > email のみの Customer を save → findById で再構成すると ContactInfo が不変条件を満たす 322ms
packages/db test:    ✓ DrizzleCustomerRepository > 行 → Customer の再構成が集約不変条件を満たす > phone と email の両方を持つ Customer を save → findById で再構成すると ContactInfo が不変条件を満たす 320ms
packages/db test:  Test Files  1 passed (1)
packages/db test:       Tests  7 passed (7)
packages/db test:    Start at  23:24:40
packages/db test:    Duration  3.04s (transform 58ms, setup 0ms, collect 265ms, tests 2.47s, environment 0ms, prepare 43ms)
...
apps/web build:  ✓ Compiled successfully in 657ms
