# Verification Result — web-services — iter 1
...
packages/shared test:    Start at  00:52:47
packages/shared test:    Duration  252ms (transform 160ms, setup 0ms, collect 214ms, tests 19ms, environment 1ms, prepare 397ms)
...
packages/catalog test:  ✓ src/service.test.ts (13 tests) 9ms
packages/scheduling test:  ✓ src/can-accommodate.test.ts (9 tests) 4ms
packages/crm test:  ✓ src/in-memory-customer-repository.test.ts (6 tests) 8ms
...
packages/catalog test:    Start at  00:52:47
packages/catalog test:    Duration  886ms (transform 126ms, setup 0ms, collect 281ms, tests 11ms, environment 0ms, prepare 439ms)
packages/crm test:  Test Files  3 passed (3)
packages/crm test:       Tests  26 passed (26)
packages/crm test:    Start at  00:52:47
packages/crm test:    Duration  905ms (transform 206ms, setup 0ms, collect 591ms, tests 18ms, environment 0ms, prepare 531ms)
packages/scheduling test:  ✓ src/in-memory-booking-repository.test.ts (11 tests) 10ms
...
packages/scheduling test:  ✓ src/available-slots.test.ts (12 tests) 11ms
...
packages/scheduling test:    Start at  00:52:47
packages/scheduling test:    Duration  985ms (transform 242ms, setup 0ms, collect 648ms, tests 32ms, environment 1ms, prepare 869ms)
...
packages/resource test:    Start at  00:52:47
packages/resource test:    Duration  1.00s (transform 264ms, setup 0ms, collect 603ms, tests 29ms, environment 0ms, prepare 879ms)
...
apps/web test:  ✓ lib/parse-customer-input.test.ts (11 tests) 5ms
apps/web test:  ✓ lib/parse-resource-input.test.ts (14 tests) 4ms
apps/web test:  ✓ app/services/actions.test.ts (3 tests) 5ms
apps/web test:  ✓ app/customers/actions.test.ts (4 tests) 7ms
apps/web test:  ✓ app/resources/actions.test.ts (4 tests) 5ms
apps/web test:  Test Files  6 passed (6)
apps/web test:       Tests  53 passed (53)
apps/web test:    Start at  00:52:48
apps/web test:    Duration  496ms (transform 294ms, setup 0ms, collect 662ms, tests 32ms, environment 1ms, prepare 369ms)
apps/web test: Done
packages/db test:  ✓ src/drizzle-customer-repository.test.ts (7 tests) 2492ms
packages/db test:    ✓ DrizzleCustomerRepository > save した Customer を findById で全フィールド一致で取得できる 530ms
packages/db test:    ✓ DrizzleCustomerRepository > 未保存の id で findById すると null が返る 335ms
packages/db test:    ✓ DrizzleCustomerRepository > 複数の Customer を save し、list が全件返す 329ms
packages/db test:    ✓ DrizzleCustomerRepository > 同一 id で再 save すると既存データが更新される（upsert） 337ms
packages/db test:    ✓ DrizzleCustomerRepository > 行 → Customer の再構成が集約不変条件を満たす > phone のみの Customer を save → findById で再構成すると ContactInfo が不変条件を満たす 323ms
packages/db test:    ✓ DrizzleCustomerRepository > 行 → Customer の再構成が集約不変条件を満たす > email のみの Customer を save → findById で再構成すると ContactInfo が不変条件を満たす 320ms
packages/db test:    ✓ DrizzleCustomerRepository > 行 → Customer の再構成が集約不変条件を満たす > phone と email の両方を持つ Customer を save → findById で再構成すると ContactInfo が不変条件を満たす 317ms
packages/db test:  Test Files  1 passed (1)
packages/db test:       Tests  7 passed (7)
packages/db test:    Start at  00:52:48
packages/db test:    Duration  3.13s (transform 127ms, setup 0ms, collect 359ms, tests 2.49s, environment 0ms, prepare 62ms)
...
apps/web build:  ✓ Compiled successfully in 782ms
apps/web build:    Linting and checking validity of types ...
apps/web build:    Collecting page data ...
apps/web build:    Generating static pages (0/7) ...
apps/web build:    Generating static pages (1/7) 
apps/web build:    Generating static pages (3/7) 
apps/web build:    Generating static pages (5/7) 
