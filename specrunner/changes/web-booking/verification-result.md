...
|---|-------|--------|----------|-----------|
| 1 | typecheck | passed | 2.4s | 0 |
| 2 | test | passed | 5.4s | 0 |
| 3 | lint | passed | 4.9s | 0 |
| 4 | build | passed | 8.4s | 0 |
...
packages/shared test:    Start at  01:32:35
packages/shared test:    Duration  254ms (transform 107ms, setup 0ms, collect 164ms, tests 21ms, environment 1ms, prepare 364ms)
...
packages/crm test:  ✓ src/customer.test.ts (13 tests) 8ms
...
packages/resource test:  ✓ src/daily-time-range.test.ts (17 tests) 11ms
...
packages/catalog test:    Start at  01:32:36
packages/catalog test:    Duration  845ms (transform 141ms, setup 0ms, collect 250ms, tests 12ms, environment 0ms, prepare 286ms)
packages/catalog test: Done
packages/crm test:  Test Files  3 passed (3)
packages/crm test:       Tests  26 passed (26)
packages/crm test:    Start at  01:32:36
packages/crm test:    Duration  898ms (transform 129ms, setup 0ms, collect 310ms, tests 19ms, environment 0ms, prepare 598ms)
...
packages/resource test:    Start at  01:32:36
packages/resource test:    Duration  975ms (transform 255ms, setup 0ms, collect 658ms, tests 28ms, environment 1ms, prepare 828ms)
packages/scheduling test:  Test Files  5 passed (5)
packages/scheduling test:       Tests  66 passed (66)
packages/scheduling test:    Start at  01:32:36
packages/scheduling test:    Duration  987ms (transform 216ms, setup 0ms, collect 809ms, tests 25ms, environment 1ms, prepare 1.09s)
...
apps/web test:  ✓ lib/create-booking-use-case.test.ts (6 tests) 8ms
apps/web test:  ✓ app/bookings/actions.test.ts (4 tests) 21ms
...
apps/web test:    Start at  01:32:37
apps/web test:    Duration  720ms (transform 333ms, setup 0ms, collect 1.04s, tests 62ms, environment 1ms, prepare 802ms)
apps/web test: Done
packages/db test:  ✓ src/drizzle-customer-repository.test.ts (7 tests) 2485ms
packages/db test:    ✓ DrizzleCustomerRepository > save した Customer を findById で全フィールド一致で取得できる 516ms
packages/db test:    ✓ DrizzleCustomerRepository > 未保存の id で findById すると null が返る 343ms
packages/db test:    ✓ DrizzleCustomerRepository > 複数の Customer を save し、list が全件返す 325ms
packages/db test:    ✓ DrizzleCustomerRepository > 同一 id で再 save すると既存データが更新される（upsert） 327ms
packages/db test:    ✓ DrizzleCustomerRepository > 行 → Customer の再構成が集約不変条件を満たす > phone のみの Customer を save → findById で再構成すると ContactInfo が不変条件を満たす 326ms
packages/db test:    ✓ DrizzleCustomerRepository > 行 → Customer の再構成が集約不変条件を満たす > email のみの Customer を save → findById で再構成すると ContactInfo が不変条件を満たす 325ms
...
packages/db test:    Start at  01:32:37
packages/db test:    Duration  3.28s (transform 89ms, setup 0ms, collect 444ms, tests 2.48s, environment 0ms, prepare 111ms)
...
apps/web build:  ✓ Compiled successfully in 1079ms
